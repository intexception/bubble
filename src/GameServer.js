...
function GameServer(mult, prt) {
    ...
    this.config = { // Border - Right: X increases, Down: Y increases (as of 2015-05-20)
        ...
        foodSpawnAmount: 15, // The amount of food to spawn per interval
        foodStartAmount: 200, // The starting amount of food in the map
        foodMaxAmount: 1500, // Maximum food cells on the map
        foodMass: 4, // Starting food size (In mass)
	    foodMaxMass: 10, // Maximum food size (In mass)
        virusMinAmount: 10, // Minimum amount of viruses on the map. 
        virusMaxAmount: 50, // Maximum amount of viruses on the map. If this amount is reached, then ejected cells will pass through viruses.
        virusStartMass: 100, // Starting virus size (In mass)
        virusBurstMass: 198, // Viruses explode past this size
        ejectMass: 10, // Mass of ejected cells
        ejectMassGain: 16, // Amount of mass gained from consuming ejected cells
